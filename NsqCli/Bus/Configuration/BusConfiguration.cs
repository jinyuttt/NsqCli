...
using System.Linq;
using NsqCli.Api;
using NsqCli.Bus.Configuration.BuiltIn;
using NsqCli.Bus.Configuration.Providers;
using NsqCli.Bus.Logging;
using NsqCli.Bus.Utils;
using NsqCli.Core;
using NsqCli.Utils;
using NsqCli.Utils.Loggers;
...
namespace NsqCli.Bus.Configuration
{
    ...
    public class BusConfiguration : IBusConfiguration
    {
        ...
        /// <param name="nsqLogger">The <see cref="ILogger"/> used by NsqCli when communicating with nsqd/nsqlookupd.
